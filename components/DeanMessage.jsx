        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative w-full h-96 lg:h-[500px] rounded-2xl overflow-hidden card-shadow">
              <img
                src="https://d31nhj1t453igc.cloudfront.net/cloudinary/2022/Apr/08/imOSR3BLBDw2Xckl2c4R.jpg"
                alt="معالي العميدة - صورة رسمية"
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold mb-4">
                <span className="gradient-text">كلمة معالي العميدة</span>
              </h2>
              <div className="text-lg text-gray-600 mb-6">
                <p className="font-semibold">الأستاذة الدكتورة / [اسم العميدة]</p>
                <p>عميدة كلية البنات الطبية</p>
              </div>
            </div>
