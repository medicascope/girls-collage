const StrategicGoals = ({ aboutData }) => {
  const fallbackGoals = [
    {
      ...
      description:
        "تطوير برامج تعليمية متقدمة تواكب أحدث التطورات في المجال الطبي وتخرج كوادر طبية متميزة قادرة على المنافسة عالمياً",
      objectives: [
    ...
    },
    {
      ...
      description:
        "الحفاظ على أعلى معايير الجودة في جميع البرامج والخدمات والحصول على الاعتماد من أفضل المؤسسات المحلية والدولية",
      objectives: [
    ...
    },
    {
      ...
      description:
        "تطوير البحث العلمي المتقدم والابتكار في المجال الطبي لحل المشكلات الصحية المجتمعية وتطوير العلوم الطبية",
      objectives: [
    ...
    },
    {
      ...
      description:
        "تقديم خدمات صحية متميزة للمجتمع وبناء شراكات استراتيجية مع القطاع الصحي والمؤسسات التعليمية",
      objectives: [
  ...
  const goals =
    aboutData?.strategicGoals?.length > 0
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            <span className="gradient-text">
              {aboutData?.strategicGoalsTitle ||
                "الغايات والأهداف الاستراتيجية"}
            </span>
          </h2>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto">
            {aboutData?.strategicGoalsSubtitle ||
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {goals.map((goal, index) => (
            <div key={index} className="bg-white p-8 rounded-2xl card-shadow">
              <div className="flex flex-col items-center text-center sm:flex-row sm:items-center sm:text-right space-y-4 sm:space-y-0 sm:space-x-reverse sm:space-x-4 mb-6">
                <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center text-white flex-shrink-0 ml-0 mr-0 sm:ml-5">
                  {goal.icon}
                </div>
              ...
              <div className="space-y-3">
                ...
                {goal.objectives.map((objective, objIndex) => (
                  ...
                  >
                    <div className="w-6 h-6 mr-0 ml-[5px] bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg
