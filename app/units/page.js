...
export const metadata = {
  ...
  description:
    "تعرف على وحدات كلية البنات الطبية المتخصصة ودورها في تطوير التعليم الطبي وضمان الجودة",
};
...
const units = [
  {
    ...
    description:
      "تهدف إلى ضمان جودة التعليم الطبي والحصول على الاعتماد الأكاديمي",
    icon: "🏆",
    headName: "د. سارة أحمد المالكي",
    headTitle: "رئيسة وحدة ضمان الجودة",
    vision:
      "تحقيق التميز في جودة التعليم الطبي والحصول على الاعتماد الأكاديمي المحلي والدولي",
    mission:
      "تطبيق معايير الجودة الشاملة في جميع أنشطة الكلية التعليمية والبحثية والخدمية",
    objectives: [
  ...
  },
  {
    ...
    description:
      "تختص بتطوير أساليب القياس والتقويم لضمان فعالية التعليم الطبي",
    icon: "📊",
    headName: "د. نورا عبدالله السالم",
    headTitle: "رئيسة وحدة القياس والتقويم",
    vision:
      "تطوير أدوات قياس وتقويم متطورة لضمان تحقيق مخرجات التعلم المستهدفة",
    mission:
      "تصميم وتطوير آليات القياس والتقويم الشاملة للطالبات والبرامج الأكاديمية",
    objectives: [
  ...
  },
  {
    ...
    description:
      "تطوير وإدارة منصات التعلم الإلكتروني والتقنيات التعليمية الحديثة",
    icon: "💻",
    ...
    mission:
      "توفير بيئة تعلم إلكتروني متطورة تدعم العملية التعليمية وتطور مهارات الطالبات",
    objectives: [
  ...
  },
  {
    ...
    mission:
      "توفير تدريب عملي متدرج ومحاكاة حقيقية للممارسة الطبية في بيئة آمنة",
    objectives: [
  ...
  },
  {
    ...
    mission:
      "تطوير قدرات البحث العلمي ودعم الباحثات لإنتاج بحوث متميزة تخدم المجال الطبي",
    objectives: [
      "تطوير البحوث الطبية",
  ...
  },
  {
    ...
    mission:
      "تطوير خطط شاملة لإدارة الأزمات وتدريب المجتمع الجامعي على التعامل معها",
    objectives: [
      "وضع خطط الطوارئ",
      "تدريب فرق الاستجابة",
        ...
        <div className="section-container relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              تضم كلية البنات الطبية مجموعة من الوحدات المتخصصة التي تعمل على
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="section-container text-center">
          ...
          <p className="text-xl mb-12 max-w-4xl mx-auto opacity-90">
            للتواصل مع أي من وحدات الكلية أو الحصول على معلومات إضافية حول
            خدماتها
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white bg-opacity-20 p-8 rounded-xl">
              ...
              <p className="opacity-80 mt-2 text-black">
