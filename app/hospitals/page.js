...
export const metadata = {
  ...
  description:
    "تعرف على مستشفيات كلية البنات الطبية التعليمية وخدماتها الطبية المتخصصة وأرقام التواصل",
};
...
const hospitals = [
  {
    ...
    description:
      "المستشفى التعليمي الرئيسي للكلية يقدم خدمات طبية شاملة ومتقدمة",
  ...
  },
  {
    ...
    description:
      "مستشفى متخصص في رعاية الأطفال وحديثي الولادة مع كادر طبي متميز",
    ...
    certifications: [
      "اعتماد وزارة الصحة",
      "شهادة جودة رعاية الأطفال",
      "اعتماد خدمات حديثي الولادة",
    ],
  },
];
        ...
        <div className="section-container">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              تضم كلية البنات الطبية شبكة من المستشفيات التعليمية المتطورة التي
              تقدم خدمات طبية عالية الجودة وتوفر بيئة تدريبية مثالية للطالبات في
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-pink-600 text-white">
        <div className="section-container text-center">
          ...
          <p className="text-xl mb-12 max-w-4xl mx-auto opacity-90">
            في حالات الطوارئ، يرجى الاتصال على الأرقام التالية للحصول على
            المساعدة الفورية
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white bg-opacity-20 p-8 rounded-xl">
              ...
              <p className="opacity-80 mt-2">
                خدمة طوارئ مجانية على مدار الساعة
              </p>
            </div>
            ...
            <div className="bg-white bg-opacity-20 p-8 rounded-xl">
              ...
              <p className="opacity-80 mt-2">
                طوارئ متخصصة للأطفال وحديثي الولادة
              </p>
            </div>
          </div>
        </div>
